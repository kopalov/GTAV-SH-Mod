...
namespace PLAYER
{
	...
	static int _GET_NETWORK_PARTICIPANT_HANDLE(Player player) { return invoke<int>(0x9EC6603812C24710, player); } // 0x9EC6603812C24710 0x98F3B274
	...
	static Player _PLAYER_ID() { return invoke<Player>(0xEE68096F9F37341E); } // 0xEE68096F9F37341E 0x8DD5B838
	...
	static void _0xF745B37630DF176B(int threadId, int p1) { invoke<Void>(0xF745B37630DF176B, threadId, p1); } // 0xF745B37630DF176B 0x882D3EB3
	...
	static void _0x1DE37BBF9E9CC14A(Player player) { invoke<Void>(0x1DE37BBF9E9CC14A, player); } // 0x1DE37BBF9E9CC14A 0xAF7AFCC4
	...
	static void _0x4AACB96203D11A31(Player player) { invoke<Void>(0x4AACB96203D11A31, player); } // 0x4AACB96203D11A31 0x7E3BFBC5
	static BOOL _0xE4B90F367BD81752(Player player) { return invoke<BOOL>(0xE4B90F367BD81752, player); } // 0xE4B90F367BD81752 0xA3707DFC
	...
	static void _0x2E8AABFA40A84F8C(Player player, BOOL p1) { invoke<Void>(0x2E8AABFA40A84F8C, player, p1); } // 0x2E8AABFA40A84F8C 0xCCD937E7
	...
	static void _0x9CB5CE07A3968D5A(Player player) { invoke<Void>(0x9CB5CE07A3968D5A, player); } // 0x9CB5CE07A3968D5A 0x0751908A
	...
	static void _0x2E7B9B683481687D(Player player, BOOL p1, BOOL p2) { invoke<Void>(0x2E7B9B683481687D, player, p1, p2); } // 0x2E7B9B683481687D 0x6F463F56
	static void _0xF113E3AA9BC54613(Player player, BOOL p1, BOOL p2) { invoke<Void>(0xF113E3AA9BC54613, player, p1, p2); } // 0xF113E3AA9BC54613 0xAB55D8F3
	static void _0xF733F45FA4497D93(Player player, BOOL p1, BOOL p2) { invoke<Void>(0xF733F45FA4497D93, player, p1, p2); } // 0xF733F45FA4497D93 0xF440C04D
	static void _0xED481732DFF7E997(Player player, BOOL p1) { invoke<Void>(0xED481732DFF7E997, player, p1); } // 0xED481732DFF7E997 0x5FEE98A2
	static void _0xB7B0870EB531D08D(Player player, int p1, BOOL p2) { invoke<Void>(0xB7B0870EB531D08D, player, p1, p2); } // 0xB7B0870EB531D08D 0x72429998
	...
	static void _0x1D506DBBBC51E64B(Player player, BOOL p1) { invoke<Void>(0x1D506DBBBC51E64B, player, p1); } // 0x1D506DBBBC51E64B 0x9F80F6DF
	...
	static void _0xAF04C87F5DC1DF38(Player player, Any p1) { invoke<Void>(0xAF04C87F5DC1DF38, player, p1); } // 0xAF04C87F5DC1DF38 0x70689638
	static void _0xD5A016BC3C09CF40(Player player, Any* p1) { invoke<Void>(0xD5A016BC3C09CF40, player, p1); } // 0xD5A016BC3C09CF40 0x77B8EF01
	...
	static void _0x7DDAB28D31FAC363(Player player) { invoke<Void>(0x7DDAB28D31FAC363, player); } // 0x7DDAB28D31FAC363 0xA3E4798E
	static BOOL _0x5DDFE2FF727F3CA3(Player player) { return invoke<BOOL>(0x5DDFE2FF727F3CA3, player); } // 0x5DDFE2FF727F3CA3 0x30DA1DA1
	...
	static void _0xB2C1A29588A9F47C(Player player, float p1) { invoke<Void>(0xB2C1A29588A9F47C, player, p1); } // 0xB2C1A29588A9F47C 0x8D2D89C4
	static BOOL _0xF297383AA91DCA29(Player player, Any p1) { return invoke<BOOL>(0xF297383AA91DCA29, player, p1); } // 0xF297383AA91DCA29 0x1C70B2EB
	...
	static void _0x9F343285A00B4BB6(Player player, BOOL p1) { invoke<Void>(0x9F343285A00B4BB6, player, p1); } // 0x9F343285A00B4BB6 0xA97C2059
	...
	static void _0x4E9021C1FCDD507A(Player player, float p1) { invoke<Void>(0x4E9021C1FCDD507A, player, p1); } // 0x4E9021C1FCDD507A 0x3D26105F
	...
	static void _0x749FADDF97DFE930(Player player, BOOL p1) { invoke<Void>(0x749FADDF97DFE930, player, p1); } // 0x749FADDF97DFE930 0xF7A0F00F
	static void _0x9F7BBA2EA6372500(int p0) { invoke<Void>(0x9F7BBA2EA6372500, p0); } // 0x9F7BBA2EA6372500 0xB8209F16
	static void _0x14D913B777DFF5DA(int p0) { invoke<Void>(0x14D913B777DFF5DA, p0); } // 0x14D913B777DFF5DA 0x8D9FD4D1
	static void _0xED51733DC73AED51(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7) { invoke<Void>(0xED51733DC73AED51, p0, p1, p2, p3, p4, p5, p6, p7); } // 0xED51733DC73AED51 0xECD12E60
	static void _0x1DD5897E2FA6E7C9() { invoke<Void>(0x1DD5897E2FA6E7C9); } // 0x1DD5897E2FA6E7C9 0x96100EA4
	static BOOL _0xD705740BB0A1CF4C(Player player) { return invoke<BOOL>(0xD705740BB0A1CF4C, player); } // 0xD705740BB0A1CF4C 0x4A01B76A
	...
	static BOOL _0xD55DDFB47991A294(Player player) { return invoke<BOOL>(0xD55DDFB47991A294, player); } // 0xD55DDFB47991A294 0xFEA40B6C
	...
	static void _0xD9284A8C0D48352C(Player player, int p1, Any p2, Any p3, BOOL p4) { invoke<Void>(0xD9284A8C0D48352C, player, p1, p2, p3, p4); } // 0xD9284A8C0D48352C 0x9254249D
	static void _0x0F4CC924CF8C7B21(Player player) { invoke<Void>(0x0F4CC924CF8C7B21, player); } // 0x0F4CC924CF8C7B21 0xFD60F5AB
	...
	static void _0x8753997EB5F6EE3F(Player player) { invoke<Void>(0x8753997EB5F6EE3F, player); } // 0x8753997EB5F6EE3F 0x6FF034BB
	static void _0xDC80A4C2F18A2B64(Player player, Hash model) { invoke<Void>(0xDC80A4C2F18A2B64, player, model); } // 0xDC80A4C2F18A2B64 0xA877FF5E
	static void _0x10C54E4389C12B42(Player player) { invoke<Void>(0x10C54E4389C12B42, player); } // 0x10C54E4389C12B42 0xBB62AAC5
	static void _0xC142BE3BB9CE125F(Player player) { invoke<Void>(0xC142BE3BB9CE125F, player); } // 0xC142BE3BB9CE125F 0x8C6E611D
...
namespace ENTITY
{
	...
	static BOOL _0xDDE6DF5AE89981D2(Entity entity, BOOL p1) { return invoke<BOOL>(0xDDE6DF5AE89981D2, entity, p1); } // 0xDDE6DF5AE89981D2 0xACFEB3F9
	...
	static Any _0xFEDDF04D62B8D790(char* animDict, Any p1) { return invoke<Any>(0xFEDDF04D62B8D790, animDict, p1); } // 0xFEDDF04D62B8D790
	...
	static Any _0x04A2A40C73395041(Entity entity) { return invoke<Any>(0x04A2A40C73395041, entity); } // 0x04A2A40C73395041 0xC46F74AC
	...
	static BOOL _0xEE5D2A122E09EC42(Entity entity, float x, float y, float z, BOOL p4) { return invoke<BOOL>(0xEE5D2A122E09EC42, entity, x, y, z, p4); } // 0xEE5D2A122E09EC42 0xEA127CBC
	...
	static void _APPLY_FORCE_TO_ENTITY_2(Entity entity, int forceType, float x, float y, float z, BOOL p5, BOOL p6, BOOL p7, BOOL p8) { invoke<Void>(0x18FF00FC7EFF559E, entity, forceType, x, y, z, p5, p6, p7, p8); } // 0x18FF00FC7EFF559E 0x28924E98
...
namespace PED
{
	...
	static BOOL _IS_PED_PERFORMING_ANIM(Ped ped, char* animDict, char* anim) { return invoke<BOOL>(0x6EC47A344923E1ED, ped, animDict, anim); } // 0x6EC47A344923E1ED 0x3C30B447
	...
	static void SET_PED_HEAD_OVERLAY(Ped ped, int index, int p2, float p3) { invoke<Void>(0x48F44967FA05CC1E, ped, index, p2, p3); } // 0x48F44967FA05CC1E 0xD28DBA90
...
namespace VEHICLE
{
	...
	static BOOL _0xA4822F1CF23F4810(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<BOOL>(0xA4822F1CF23F4810, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0xA4822F1CF23F4810 0x34E02FCD
...
namespace AI
{
	...
	static void TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Ped ped, Entity entity, float offsetX, float offsetY, float offsetZ, float radius, int p6, float p7, BOOL p8) { invoke<Void>(0x304AE42E357B8C7E, ped, entity, offsetX, offsetY, offsetZ, radius, p6, p7, p8); } // 0x304AE42E357B8C7E 0x2DF5A6AC
	...
	static BOOL _HAS_TASK_MOBILE_PHONE(Ped ped) { return invoke<BOOL>(0xB8EBB1E9D3588C10, ped); } // 0xB8EBB1E9D3588C10 0x500B6805
	...
	static void TASK_SHOOT_AT_COORD(Ped ped, float x, float y, float z, Any p4, Any p5) { invoke<Void>(0x46A6CC01E0826106, ped, x, y, z, p4, p5); } // 0x46A6CC01E0826106 0x601C22E3
	...
	static void TASK_HELI_CHASE(Ped pilot, Vehicle vehicleToFollow, float x, float y, float z) { invoke<Void>(0xAC83B1DB38D0ADA0, pilot, vehicleToFollow, x, y, z); } // 0xAC83B1DB38D0ADA0 0xAC290A21
	...
	static void TASK_PLANE_MISSION(Ped Pilot, Vehicle Aeroplane, Any p2, Any p3, float DestinationX, float DestinationY, float DestinationZ, int p7, float p8, float p9, float p10, float maxSpeed, float minSpeed) { invoke<Void>(0x23703CD154E83B88, Pilot, Aeroplane, p2, p3, DestinationX, DestinationY, DestinationZ, p7, p8, p9, p10, maxSpeed, minSpeed); } // 0x23703CD154E83B88 0x1D007E65
...
namespace WEAPON
{
	...
	static Entity _0x3B390A939AF0B5FC(Ped ped) { return invoke<Entity>(0x3B390A939AF0B5FC, ped); } // 0x3B390A939AF0B5FC 0x5D73CD20
	static Any GET_BEST_PED_WEAPON(Ped ped, BOOL p1) { return invoke<Any>(0x8483E98E8B888AE2, ped, p1); } // 0x8483E98E8B888AE2 0xB998D444
	static Any SET_CURRENT_PED_VEHICLE_WEAPON(Ped ped, Hash weaponHash) { return invoke<Any>(0x75C55983C2C39DAA, ped, weaponHash); } // 0x75C55983C2C39DAA 0x8E6F2AF1
	...
	static BOOL _0x65F0C5AE05943EC7(Ped ped) { return invoke<BOOL>(0x65F0C5AE05943EC7, ped); } // 0x65F0C5AE05943EC7 0xBAF7BFBE
	...
	static Any _0xCEA66DAD478CD39B(float p0) { return invoke<Any>(0xCEA66DAD478CD39B, p0); } // 0xCEA66DAD478CD39B 0xB0127EA7
	...
	static BOOL _0xBC7BE5ABC0879F74(Hash weaponHash) { return invoke<BOOL>(0xBC7BE5ABC0879F74, weaponHash); } // 0xBC7BE5ABC0879F74 0x135E7AD4
}
...
namespace GRAPHICS
{
	...
	static void SET_CHECKPOINT_CYLINDER_HEIGHT(int* Checkpoint, float p1, float Height, float p3) { invoke<Void>(0x2707AAE9D9297D89, Checkpoint, p1, Height, p3); } // 0x2707AAE9D9297D89 0xFF0F9B22
	...
	static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_ENTITY_2(Any* p0, Any p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, BOOL p9, BOOL p10, BOOL p11) { return invoke<BOOL>(0xC95EB1DB6E92113D, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0xC95EB1DB6E92113D
	...
	static void DRAW_SCALEFORM_MOVIE(Any handle, float x, float y, float width, float height, int r, int g, int b, int a) { invoke<Void>(0x54972ADAF0294A93, handle, x, y, width, height, r, g, b, a); } // 0x54972ADAF0294A93 0x48DA6A58
	...
	static void _0xCF537FDE4FBD4CE5(int p0, Any p1, int red, int green, int blue, int alpha) { invoke<Void>(0xCF537FDE4FBD4CE5, p0, p1, red, green, blue, alpha); } // 0xCF537FDE4FBD4CE5 0x9C59FC06
...
namespace DECISIONEVENT
{
	...
	static Any ADD_SHOCKING_EVENT_FOR_ENTITY(int maybeTypeOfEvent, Entity entity, float duration) { return invoke<Any>(0x7FD8F3BE76F89422, maybeTypeOfEvent, entity, duration); } // 0x7FD8F3BE76F89422 0xA81B5B71
...
namespace WATER
{
	...
	static Any _0x2B3451FA1E3142E2(float x, float y, float z, Any p3, Any* p4) { return invoke<Any>(0x2B3451FA1E3142E2, x, y, z, p3, p4); } // 0x2B3451FA1E3142E2 0x4C71D143
...
namespace NETWORK
{
	...
	static BOOL NETWORK_DO_TRANSITION_TO_FREEMODE(Any* p0, Any p1, BOOL p2, int always32) { return invoke<BOOL>(0x3AAD8B2FCA1E289F, p0, p1, p2, always32); } // 0x3AAD8B2FCA1E289F 0xC7CB8ADF
